...
) : UseCase<String, List<GameRemoteRepository.GameInfoResponse.Game>> {
    override suspend fun invoke(vararg arguments: String): Result<List<GameRemoteRepository.GameInfoResponse.Game>> {
