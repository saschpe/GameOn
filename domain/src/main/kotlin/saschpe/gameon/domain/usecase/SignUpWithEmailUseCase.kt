...
class SignUpWithEmailUseCase(private val userRepository: UserRepository) : UseCase<String, AuthResult> {
    override suspend fun invoke(vararg arguments: String): Result<AuthResult> {
        require(arguments.size == 2)
        return userRepository.createUserWithEmail(arguments[0], arguments[1])
    }
}
