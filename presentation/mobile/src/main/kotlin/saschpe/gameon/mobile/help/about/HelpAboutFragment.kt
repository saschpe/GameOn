...
class HelpAboutFragment : Fragment() {
    private lateinit var binding: FragmentHelpAboutBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentHelpAboutBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.copyrightText.text =
            getString(R.string.copyright_notice_template, Calendar.getInstance().get(Calendar.YEAR))
    }
